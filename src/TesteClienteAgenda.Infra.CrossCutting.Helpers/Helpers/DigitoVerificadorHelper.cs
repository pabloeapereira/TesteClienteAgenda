...
{
    public class DigitoVerificadorHelper:IDisposable
    {
        ...
        public DigitoVerificadorHelper(string numero)
        {
            _numero = numero;
        }

        public DigitoVerificadorHelper ComMultiplicadoresDeAte(int primeiroMultiplicador, int ultimoMultiplicador)
        {
        ...
        public DigitoVerificadorHelper Substituindo(string substituto, params int[] digitos)
        {
